...
import { FaEnvelope, FaLock, FaEye, FaEyeSlash, FaGoogle, FaGithub, FaArrowLeft, FaRunning, FaSignInAlt } from "react-icons/fa";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-24 h-24 bg-purple-400/10 rounded-full blur-xl"></div>
      <div className="absolute bottom-1/3 right-1/4 w-20 h-20 bg-blue-400/10 rounded-full blur-xl"></div>
      ...
      >
        {/* Decorative Header */}
        <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700 p-6 text-white text-center relative overflow-hidden">
          ...
          >
            ...
            <p className="text-blue-100 opacity-90">Continue your fitness journey with us</p>
          </motion.div>
        </div>
        ...
        <form onSubmit={handleLogin} className="p-8">
          ...
          <motion.button
            ...
            className={`w-full mt-8 py-4 px-6 rounded-xl text-white font-semibold shadow-lg transition-all duration-300 transform
              ${isLoading 
                ...
                : 'bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 hover:shadow-xl hover:-translate-y-0.5'}`}
          >
            {isLoading ? (
          ...
          >
            ...
            <span className="mx-4 text-sm text-gray-500">Quick access</span>
            <div className="flex-grow border-t border-gray-200"></div>
          </motion.div>
          ...
          >
            <button
              type="button"
              className="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-200 text-gray-700 py-3 rounded-xl hover:bg-gray-50 hover:border-red-300 transition-all duration-300 shadow-sm hover:shadow-md"
            >
          ...
          >
            ...
            <button 
              ...
              className="text-purple-600 font-medium hover:text-blue-600 transition-colors hover:underline"
            >
              Join Our Community
            </button>
          </motion.p>
